...
export default async function MatierePage({ params }: Props) {
  ...
  const matiere = matieresPremiere.find((m) => m.slug === slug);

  if (!matiere) notFound();

  const niveau = "premiere-secondaire";

  return (
    <div className="max-w-5xl mx-auto px-4 py-12">
      <div className="mb-10">
        <p className="text-sm text-gray-500 mb-1">
          Mathématiques &rsaquo; 1ère Secondaire
        </p>
